...
(function () {
  ...
  function patchDecryptedContent(html) {
    ...
    var chatbotJS =
      ...
      'function getIframeSrc(){var base=getAppUrl();var api=(sidebar&&sidebar.getAttribute("data-chat-api"))||window.SRINI_CHAT_API||"";if(api)return base+"?api="+encodeURIComponent(api.replace(/\\/$/,""));return base;}' +
